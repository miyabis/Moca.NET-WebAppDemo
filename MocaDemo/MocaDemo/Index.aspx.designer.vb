...
Partial Public Class Index
    ...
    '''</remarks>
    Protected WithEvents lblCookieOld As Global.System.Web.UI.WebControls.Label
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents lblVSOld As Global.System.Web.UI.WebControls.Label
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents lblVS As Global.System.Web.UI.WebControls.Label
